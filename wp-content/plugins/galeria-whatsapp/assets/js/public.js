    ...
    function displayPhotos(photos) {
        ...
        photos.forEach(function(photo) {
            ...
            var photoHtml = '<div class="galeria-item" data-photo-id="' + photo.photo_id + '" data-folder="' + (photo.folder_id || 0) + '">' +
                ...
                '</div>' +
                '<button class="galeria-meta-btn" data-whatsapp="' + whatsappUrl + '">WhatsApp</button>' +
                '</div>' +
                '</div>';
        ...
        // Delegar click en botón inferior
        $(document).off('click', '.galeria-meta-btn').on('click', '.galeria-meta-btn', function() {
            var url = $(this).data('whatsapp');
